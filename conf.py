...
BLOG_TITLE = "hedgenet blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://hedgenet.info/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://hedgenet.info/"
BLOG_EMAIL = "jopela@hedgenet.info"
BLOG_DESCRIPTION = "hedgenet.info official's blog"  # (translatable)
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-6301775595808678",
